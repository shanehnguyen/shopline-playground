    ...
    class FeaturedCollectionTabs extends HTMLElement {
      ...
      switchTo(blockId, awaitTime) {
        ...
        this.tabs.forEach(async (tab) => {
          ...
          const arrows = this.parentElement.querySelector(`.slider-block-arrows--${currentId}`);
          arrows && arrows.classList.toggle('display-none', !isActive);
          ...
          let content = this.parentElement.querySelector(`.slider-block--${currentId}`);
          if (isActive && !content) {
