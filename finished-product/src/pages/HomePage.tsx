...
import { ChevronLeft, ChevronRight, Box, ShoppingCart, Star, ShieldCheck, User, Mail, Phone, Facebook, Linkedin, Instagram, Eye, X, Minus, Plus } from 'lucide-react';
            ...
            <div className="w-full md:w-1/2 p-6 md:p-12 space-y-4 md:space-y-6 flex flex-col justify-center">
              <div className="space-y-2">
                <div className="space-y-1">
                  ...
                  <p className="text-[11px] text-pk-muted font-medium">SKU: {product.subtitle}</p>
                </div>
              ...
              <div className="space-y-3">
                ...
                <ul className="space-y-1.5 md:space-y-2">
                  {[
                    "Solid wood frame with HDF center panel",
                    "¾\" plywood box construction",
                    "Concealed undermount soft-close hinges",
                    "Scratch-resistant multilayered AC paint finish",
                    "Adjustable shelves",
                    "Ships from Texas warehouse in 3 days"
                  ].map((feature, i) => (
                    <li key={i} className="flex items-start gap-2 text-[12px] md:text-[13px] text-pk-muted">
                ...
                <div className="flex items-center gap-4">
                  <div className="flex items-center border border-pk-input-border">
                    ...
                    <input 
                      ...
                      value={quantity}
                      readOnly
                      className="w-10 text-center text-[14px] font-medium focus:outline-none bg-transparent"
                    />
                    <button 
                  ...
                  <Button 
                    ...
                    className="flex-1 py-3 md:py-4 text-[12px] md:text-[13px] uppercase tracking-[0.15em]"
                  >
                    Add to Cart
                  </Button>
                </div>
...
const ProductCard: React.FC<{ product: any; index: number; onQuickView: (product: any) => void }> = ({ product, index, onQuickView }) => {
  ...
  return (
    ...
    >
      <div className="relative aspect-square mb-6 overflow-hidden bg-white rounded-sm group/image shadow-sm hover:shadow-md transition-shadow duration-500">
        ...
        {/* Quick Actions */}
        <div className="absolute top-3 right-3 z-20 flex flex-col gap-2 opacity-100 md:opacity-0 md:group-hover/image:opacity-100 transition-all transform translate-y-0 md:translate-y-2 md:group-hover/image:translate-y-0">
          <button 
            onClick={(e) => {
              e.preventDefault();
              e.stopPropagation();
            ...
            className="w-9 h-9 rounded-full bg-white/90 backdrop-blur-sm flex items-center justify-center text-pk-dark shadow-sm transition-all"
            title="Quick View"
          >
            <Eye size={18} />
          </button>
...
const HomePage: React.FC = () => {
  ...
  return (
    <Layout>
      ...
      {/* Trust Bar Section */}
      <section className="relative h-auto md:h-20 bg-white border-y border-pk-border overflow-hidden py-6 md:py-0">
        ...
        <div className="flex items-center px-4 md:px-8 overflow-x-auto no-scrollbar h-full">
      ...
      <section className="px-4 md:px-8 py-12 md:py-[72px] bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {/* <!-- DYNAMIC: loop through collections here --> */}
            {[
              { name: 'Mallorca', image: images.collections.mallorca },
              { name: 'Shady', image: images.collections.shady },
              { name: 'Franco', image: images.collections.franco },
              { name: 'Irena', image: images.collections.irena },
              { name: 'Newport', image: images.collections.newport },
              { name: 'Aspen', image: images.collections.aspen },
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1, duration: 0.6 }}
                className="relative aspect-[3/4] overflow-hidden cursor-pointer group bg-white"
              >
                {/* <!-- DYNAMIC: collection image --> */}
                <img 
      ...
      <section className="px-4 md:px-8 py-12 md:py-[72px] bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto">
          ...
          >
            {/* <!-- DYNAMIC: loop through featured products here --> */}
      ...
      <section className="w-full">
        ...
        >
          <img 
            src={images.collections.shadyGrayPromo} 
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 md:gap-8">
            {[
              { 
                ...
                bgImage: images.hero.whiteShakerBanner,
                doorImage: images.sampleDoors.francoWhiteSample
              },
              { 
                ...
                bgImage: images.sampleDoors.grayShakerBanner,
                doorImage: images.sampleDoors.mallorcaGraySample
              },
              { 
                ...
                bgImage: images.sampleDoors.shorelineBanner,
                doorImage: images.sampleDoors.newportShorelineSample
              },
              { 
                ...
                bgImage: images.sampleDoors.aspenBg,
                doorImage: images.sampleDoors.aspenSample
              },
              { 
                ...
                bgImage: images.sampleDoors.slimBlackSample,
                doorImage: images.sampleDoors.francoSlimBlackSample
              },
              { 
                ...
                bgImage: images.sampleDoors.naturalOakBanner,
                doorImage: images.sampleDoors.newportOakSample
              }
            ].map((door, index) => (
              <motion.div
                key={door.name}
              ...
              >
                ...
                >
                  <div className="relative w-full aspect-[3/4] mb-4 overflow-hidden rounded-sm bg-white">
                    <img 
                      src={door.bgImage} 
                    ...
                    <img 
                      src={door.doorImage} 
                      alt={door.name}
                      className="absolute inset-0 w-full h-full object-cover opacity-0 transition-opacity duration-300 ease group-hover:opacity-100"
                      referrerPolicy="no-referrer"
                    />
                  </div>
      ...
      <section className="bg-white border-y border-pk-border py-12">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-5 gap-y-12 md:gap-y-0 md:divide-x md:divide-pk-border">
          ...
          <div className="flex flex-col items-center justify-center text-center px-4 space-y-2 border-l border-pk-border md:border-l-0">
          ...
          <div className="flex flex-col items-center justify-center text-center px-4 space-y-2 col-span-2 md:col-span-1">
