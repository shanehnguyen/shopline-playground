...
const ContactPage: React.FC = () => {
  return (
    <Layout>
      ...
      {/* Section 2 — Location */}
      <section className="bg-white pt-[60px] md:pt-[72px] pb-[60px] md:pb-[72px] px-4 md:px-8 border-t border-pk-border">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[45%_55%] gap-x-12 items-stretch min-h-[500px]">
            {/* Card Area */}
            <div className="flex flex-col">
              <motion.div
                ...
                className="w-full border border-pk-border p-10 space-y-8 rounded-sm h-full"
              >
                ...
                <div className="pt-4 space-y-4">
                  <p className="text-[13px] text-pk-muted leading-relaxed italic">
                    Our warehouse ships directly to your door. Visit us Monday–Friday, 8AM–5PM PST.
                  </p>
                  <p className="text-[11px] text-pk-muted uppercase tracking-wider font-medium">
            ...
            <div className="w-full h-full min-h-[400px] lg:min-h-0">
              <iframe 
                src="https://maps.google.com/maps?q=14301+Gannet+St+La+Mirada+CA+90638&output=embed"
                className="w-full h-full rounded-sm border border-pk-border"
                style={{ border: 0 }}
                allowFullScreen
                loading="lazy"
                title="PK Cabinet Location"
              />
            </div>
          </div>
        </div>
