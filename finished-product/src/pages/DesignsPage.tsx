...
const DesignsPage: React.FC = () => {
  ...
  const designs = [
    { label: "Shady White Shaker", url: images.collections.shady },
    { label: "Mallorca Dolphin Gray", url: images.collections.mallorca },
    { label: "Franco Slim Black", url: images.collections.franco },
    { label: "Irena Collection", url: images.collections.irena },
    { label: "Newport Shoreline", url: images.collections.newport },
    { label: "Aspen Stone Gray", url: images.collections.aspen },
  ];
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <form className="space-y-8">
              ...
              {/* Submit Button */}
              <Button type="submit" className="w-full py-5 shadow-lg">
                SUBMIT
              </Button>
            </form>
          </motion.div>
